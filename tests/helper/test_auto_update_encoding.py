...
@pytest.mark.asyncio
async def test_auto_update_encoding_trigger_a_valid_auto_encoding() -> None:
...
@pytest.mark.asyncio
async def test_auto_update_encoding_trigger_load_current_available_encoder() -> None:
...
@pytest.mark.asyncio
async def test_auto_update_encoding_trigger_first_encoding() -> None:
...
@pytest.mark.asyncio
async def test_auto_update_encoding_trigger_raise_an_exception() -> None:
...
@pytest.mark.asyncio
async def test_auto_update_encoding_trigger_nas_data_lte_encoded_data() -> None:
